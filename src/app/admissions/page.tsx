        ...
        <main className="min-h-screen bg-white overflow-hidden mt-[120px]" ref={containerRef}>
                ...
                <div className="relative max-w-4xl mx-auto">
                    ...
                    <div className="space-y-12">
                        {steps.map((step, index) => (
                            ...
                            >
                                {/* Icon Marker */}
                                <div className="absolute left-8 md:left-1/2 top-0 w-16 h-16 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-full border-4 border-white z-10 transform -translate-x-1/2 flex items-center justify-center text-slate-900 shadow-xl">
                                    <step.icon size={28} />
                                </div>
            ...
            >
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-400 hover:to-orange-400 text-slate-900 px-8 py-4 rounded-full font-bold text-lg shadow-2xl hover:shadow-yellow-500/50 transition-all flex items-center gap-3 group"
                >
                    Apply Now
