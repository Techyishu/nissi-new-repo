    ...
    return (
        <section id="gallery" className="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full opacity-5">
                ...
                <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-teal-500 rounded-full blur-3xl" />
            </div>
                ...
                >
                    {[...images, ...images].map((src, index) => (
                        <motion.div
                            ...
                            className="relative w-[320px] md:w-[450px] h-[240px] md:h-[300px] rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl shrink-0 group cursor-pointer"
                        >
                            <Image
                                src={src}
